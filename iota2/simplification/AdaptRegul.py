...
def regularisation(raster, threshold, nbcores, path, ram="128"):
    ...
    masktime = time.time()
    print(" ".join([" : ".join(["Masks generation for adaptive rules", str(
        masktime - init_regul)]), "seconds"]))
    ...
    print(" ".join([" : ".join(["Adaptative regularizations",
                                str(adaptativetime - masktime)]), "seconds"]))
    ...
    rastersList = [os.path.join(path, "mask_nd_1_4.tif"), os.path.join(path, "mask_nd_2_4.tif"), os.path.join(path, "mask_nd_3_4.tif"),
                   os.path.join(
        path, "mask_nd_4_4.tif"), os.path.join(
        path, "mask_nd_5_4.tif"), os.path.join(
            path, "mask_nd_6_4.tif"),
    ...
    print(" ".join([" : ".join(["Majority voting regularization",
                                str(majoritytime - adaptativetime)]), "seconds"]))

...
def OSORegularization(classif, umc1, core, path, output, ram="10000",
    ...
    regulClassif, time_regul1 = AdaptRegul.regularisation(
    ...
    if umc2 is not None:
        ...
        regulClassif, time_regul2 = AdaptRegul.regularisation(
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        # -in
        # /home/thierionv/cluster/simplification/post-processing-oso/script_oso/OSO_10m.tif
        # -inland
        # /home/thierionv/work_cluster/classifications/Simplification/masque_mer.shp
        # -nbcore 4 -umc1 10 -umc2 3 - rssize 20 -outfile
        # /home/thierionv/cluster/simplification/post-processing-oso/script_oso/out/classif_regul_20m.tif

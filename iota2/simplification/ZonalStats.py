...
def formatDataFrame(
    ...
    # change column names if rate stats expected and nomenclature file is
    # provided
    if categorical:
...
def dataframeExport(geodataframe, output, schema):
    ...
    # TODO Export format depending on columns number (shapefile, sqlite,
    # geojson) # Check Issue on framagit
    convert = False

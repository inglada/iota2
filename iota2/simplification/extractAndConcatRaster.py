...
def extractAndConcat(wd, shape_in, raster_in, raster_out, nbcore, outtype):
    ...
    for rast in raster_in:
        ...
        os.system(
            "gdalwarp  -tap -tr 10 10 -overwrite -multi -wo NUM_THREADS={} -te {} {} {}".format(
                nbcore, " ".join(extent), rast, tmprast
            )
        )
        rasttoconcat.append(tmprast)

    os.system(
        "otbcli_ConcatenateImages -il {} -out {} {}".format(
            " ".join(rasttoconcat), raster_out, outtype
        )
    )
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        PARSER.add_argument(
            "-ins", dest="ins", action="store", help="input shapefile to clip"
        )
        ...
        PARSER.add_argument(
            ...
            dest="nbcore",
            action="store",
            help="thread number for wrap operation",
            default="4",
        )
        ...
        extractAndConcat(
            args.path, args.ins, args.inr, args.out, args.nbcore, args.pixtype
        )
...
# python devcourant/extractAndConcatRaster.py -ins
# /work/OT/theia/oso/vincent/vectorisation/loiret_oso2016.shp -inr
# /work/OT/theia/oso/production/2017/oso2017.tif
# /work/OT/theia/oso/production/2017/oso2017_confidence.tif
# /work/OT/theia/oso/production/2017/oso2017_validity.tif -out
# /work/OT/theia/oso/vincent/test.tif

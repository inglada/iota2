...
def getDatesInOtbOutputName(otbObj):
    ...
    elif isinstance(otbObj, otb.Application):
        outputParameter = OtbAppBank.getInputParameterOutput(otbObj)
        return int(
            otbObj.GetParameterValue(outputParameter)
            .split("/")[-1]
            .split("_")[4]
            .split("t")[0]
        )
...
def compareDates(datesFile, dates):
    ...
    new_dates = sorted([date for date in dates if not date in old_dates])
    ...
    for d in directories[1]:
        ...
        if s1_vv_DES_scene:
            ...
            if s1_vv_DES_outcore or not os.path.exists(outcore_s1_vv_DES):
                s1_vv_DES_outcore = OtbAppBank.CreateMultitempFilteringOutcore(
                    {
        ...
        if s1_vh_DES_scene:
            ...
            new_outcore_s1_vh_DES_dates = compareDates(
            ...
            if s1_vh_DES_outcore or not os.path.exists(outcore_s1_vh_DES):
                s1_vh_DES_outcore = OtbAppBank.CreateMultitempFilteringOutcore(
                    {
        ...
        if s1_vv_ASC_scene:
            ...
            new_outcore_s1_vv_ASC_dates = compareDates(
            ...
            if s1_vv_ASC_outcore or not os.path.exists(outcore_s1_vv_ASC):
                s1_vv_ASC_outcore = OtbAppBank.CreateMultitempFilteringOutcore(
                    {
        ...
        if s1_vh_ASC_scene:
            ...
            new_outcore_s1_vh_ASC_dates = compareDates(
            ...
            if s1_vh_ASC_outcore or not os.path.exists(outcore_s1_vh_ASC):
                s1_vh_ASC_outcore = OtbAppBank.CreateMultitempFilteringOutcore(
                    {
        ...
        if s1_vv_DES_scene:
            ...
            s1_vv_DES_filtered = os.path.join(
                directories[0], d, "filtered/S1_vv_DES_Filtered.tif"
            )
            s1_vv_DES_filtered_app, a, b = OtbAppBank.CreateMultitempFilteringFilter(
                {
                    "inl": s1_vv_DES_scene,
                    "oc": outcore_s1_vv_DES,
                    "wr": str(wr),
        ...
        if s1_vh_DES_scene:
            ...
            s1_vh_DES_filtered = os.path.join(
                directories[0], d, "filtered/S1_vh_DES_Filtered.tif"
            )
            s1_vh_DES_filtered_app, a, b = OtbAppBank.CreateMultitempFilteringFilter(
                {
                    "inl": s1_vh_DES_scene,
                    "oc": outcore_s1_vh_DES,
                    "wr": str(wr),
        ...
        if s1_vv_ASC_scene:
            ...
            s1_vv_ASC_filtered = os.path.join(
                directories[0], d, "filtered/S1_vv_ASC_Filtered.tif"
            )
            s1_vv_ASC_filtered_app, a, b = OtbAppBank.CreateMultitempFilteringFilter(
                {
                    "inl": s1_vv_ASC_scene,
                    "oc": outcore_s1_vv_ASC,
                    "wr": str(wr),
        ...
        if s1_vh_ASC_scene:
            ...
            s1_vh_ASC_filtered = os.path.join(
                directories[0], d, "filtered/S1_vh_ASC_Filtered.tif"
            )
            s1_vh_ASC_filtered_app, a, b = OtbAppBank.CreateMultitempFilteringFilter(
                {
                    "inl": s1_vh_ASC_scene,
                    "oc": outcore_s1_vh_ASC,
                    "wr": str(wr),

...
class Sentinel_2_S2C(Sensor):
    ...
    def __init__(self, config_path, tile_name):
        ...
        self.write_dates_stack = self.cfg_IOTA2.getParam("Sentinel_2_S2C",
    ...
    def preprocess_date_masks(self, date_dir, out_prepro,
        ...
        invalid_expr = " or ".join(["im1b1=={}".format(flag)
    ...
    def footprint(self, ram=128):
        ...
        for date_dir in input_dates:
            ...
            scl = FileSearch_AND(r20m_dir, True, self.scene_classif)[0]
            all_scl.append(scl)
        sum_scl = "+".join(["im{}b1".format(i + 1)
                            for i in range(len(all_scl))])
    ...
    def write_dates_file(self):
        ...
        all_available_dates = [
            os.path.basename(date).split("_")[
                self.date_position].split("T")[0] for date in input_dates_dir]

...
class obiaLearning(IOTA2Step.Step):
    def __init__(self, cfg, cfg_resources_file, workingDirectory=None):
        ...
        super(obiaLearning, self).__init__(cfg, cfg_resources_file, resources_block_name)

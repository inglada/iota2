...
class learningSamplesZonalStatistics(IOTA2Step.Step):
    def __init__(self, cfg, cfg_resources_file, workingDirectory=None):
        ...
        super(learningSamplesZonalStatistics, self).__init__(cfg, cfg_resources_file, resources_block_name)
    ...
    def step_execute(self):
        ...
        step_function = lambda x: SamplesZonalStatistics.learning_samples_zonal_statistics(x, self.cfg, self.workingDirectory)

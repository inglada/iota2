...
# This script looks at two different files and compare if the same geometry
# exists in both files. If yes, keep this geometry in a new file.
...
if __name__ == '__main__':
    ...
    listfiles = []
    if len(sys.argv) == 5:
        CheckDoubleGeomTwofilesCopy(sys.argv[1], sys.argv[2], sys.argv[3],
                                    sys.argv[4])
        sys.exit(0)
    else:
        print(usage)

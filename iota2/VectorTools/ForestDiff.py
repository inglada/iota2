...
from iota2.VectorTools import BufferOgr as bo
from iota2.VectorTools import MultiPolyToPoly as mpp
from iota2.VectorTools import shapeDifference as sd
    ...
    for feat in layer:
        if feat.GetGeometryRef():
            ...
            if areahull != 0 and peripoly != 0 and largeur != 0:
                ...
                compacity = 4 * math.pi * (geom.GetArea() /
                                           math.pow(peripoly, 2))
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        parser = argparse.ArgumentParser(
            description=
            "Extract forests, hedges, and trees based on an input forest shapefile"
        )

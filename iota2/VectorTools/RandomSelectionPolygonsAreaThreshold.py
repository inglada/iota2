...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=
        "This function allows to randomnly extract polygons from input shapefile given a sum of areas threshold"
    )
    ...
    parser.add_argument(
        ...
        dest="nolistid",
        help=
        "list of field's values to not select (text file with values separated with comma)"
    )
    ...
    get_randomPolyAreaThresh(args.path, args.shape, args.field, args.classe,
                             args.thresh, args.outputlist, args.split,
                             args.output, args.nolistid)

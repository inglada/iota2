...
def traitEchantillons(
    ...
    if tmp:
        ...
        print(
            "Intermediate files are preserved in folder {}".format(
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        parser.add_argument(
            ...
            dest="output",
            action="store",
            help="Output shapefile name (store in the same folder than input shapefile)",
            required=True,
        )
        parser.add_argument(
            "-tmppath",
        ...
        parser.add_argument(
            "-csv", dest="csv", action="store", help="CSV or recode rules"
        )
        parser.add_argument(
            "-d", dest="delimiter", action="store", help="CSV delimiter"
        )
        parser.add_argument(
            "-if",
            dest="ifield",
        ...
        parser.add_argument(
            ...
            dest="areapix",
            action="store",
            help="Pixel area of the image used for classification",
            required=True,
        )
        parser.add_argument(
            "-areat",

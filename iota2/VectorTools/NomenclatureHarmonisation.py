...
import csv
import ogr
from iota2.VectorTools import ConditionalFieldRecode
...
def labelRecoding(shapefile, csvfile, delimiter, fieldin, fieldout):
    ...
    with open(csvfile, 'r') as csvfile:
        ...
        for row in csvreader:
            ConditionalFieldRecode.conFieldRecode(shapefile, fieldin, fieldout,
                                                  row[fieldin], row[fieldout])
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        labelRecoding(args.shapefile, args.csv, args.delimiter, args.ifield,
                      args.ofield)

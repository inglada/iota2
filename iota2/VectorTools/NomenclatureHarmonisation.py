...
import os
import argparse
from VectorTools import ConditionalFieldRecode
import csv
import ogr
...
def harmonisationCodeIota(shapefile, csvfile, delimiter, fieldin, fieldout):
    ...
    with open(csvfile, 'rb') as csvfile:
        ...
        for row in csvreader:
            ConditionalFieldRecode.conFieldRecode(
...
# python ../echantillons/harmonisation_code_iota2.py -s
# /home/thierion/Documents/OSO/iota2/Echantillons/references_2016/preparation/OSO_2016_dynafor.shp
# -csv
# /home/thierion/Documents/OSO/iota2/Echantillons/references_2016/preparation/Agrosolutions.csv
# -d , -if ros2016 -of CODE

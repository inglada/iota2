...
def intersectSqlites(
    t1, t2, tmp, output, epsg, operation, keepfields, vectformat="SQLite"
):
    """
    """
    ...
    for namefield1 in listnamefieldst1:
        if namefield1 in duplicates:
            listnamefieldst1[listnamefieldst1.index(namefield1)] = (
                "t1." + str(namefield1) + " as " + "t1_" + str(namefield1)
            )
        else:
            listnamefieldst1[listnamefieldst1.index(namefield1)] = "t1." + str(
                namefield1
            )

    for namefield2 in listnamefieldst2:
        if namefield2 in duplicates:
            listnamefieldst2[listnamefieldst2.index(namefield2)] = (
                "t2." + str(namefield2) + " as " + "t2_" + str(namefield2)
            )
        else:
            listnamefieldst2[listnamefieldst2.index(namefield2)] = "t2." + str(
                namefield2
            )
    ...
    if (
        os.path.splitext(os.path.basename(output))[1] == ".shp"
        and vectformat == "SQLite"
    ):
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        parser.add_argument(
            ...
            dest="s2",
            action="store",
            help="second sqlite vector file",
            required=True,
        )
        parser.add_argument(
            "-tmp",

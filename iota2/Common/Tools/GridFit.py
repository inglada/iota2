...
def getAllDatasByDate(
    ...
    # sort it by date
    buff = [
        (getDateFromRaster(currentRaster[0]), currentRaster) for currentRaster in buf
    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-in.tileFolder", dest="TileFolder", help="", default=None, required=True
    )
    parser.add_argument(
        "-in.sensorName", dest="sensorName", help="", default=None, required=True
    )
    parser.add_argument(
        "-in.rasterPatterns",
        dest="rasterPatterns",
    ...
    parser.add_argument(
        "-in.arboRaster", dest="arboRaster", help="", default=None, required=True
    )
    parser.add_argument(
        "-in.masksPatterns",
        dest="masksPatterns",
    ...
    parser.add_argument(
        "-out.interpolator", dest="interpolator", help="", default=None, required=True
    )
    parser.add_argument(
        "-out.projection", dest="outputProjection", help="", default=None, required=True
    )
    parser.add_argument(
        "-out.resolution", dest="outPixRes", help="", default=None, required=True
    )
    parser.add_argument(
        "-out.field",
    ...
    parser.add_argument(
        "-out.directory", dest="outDirectory", help="", default=None, required=True
    )
    parser.add_argument(

...
if __name__ == "__main__":
    ...
    parser.add_argument("-in.extract",
                        dest="shapeE",
                        help="path to the folder which contains samples",
                        default=None,
                        required=True)
    parser.add_argument("-in.extractDriver",
                        dest="DriverE",
                        help="driver",
                        default=None,
                        required=True)
    parser.add_argument("-in.field",
                        ...
                        default=None,
                        required=True)
    parser.add_argument("-in.field.value",
                        dest="field_val",
                        help="field's value",
                        default=None,
                        type=int,
                        required=True,
                        nargs='+')
    parser.add_argument("-in.field.value.nbExtract",
                        dest="nbextract",
                        help="field's value",
                        default=None,
                        type=int,
                        required=True,
                        nargs='+')
    parser.add_argument("-in.extract.select",
                        dest="shapeS",
                        help="path to the shapefile in which store samples",
                        default=None,
                        required=True)
    parser.add_argument("-in.field.pop",
                        dest="fieldo",
                        help="Field of the storage shapefile to populate",
                        default=None,
                        required=True)
    parser.add_argument("-in.PopDriver",
                        dest="DriverS",
                        help="driver",
                        default=None,
                        required=True)

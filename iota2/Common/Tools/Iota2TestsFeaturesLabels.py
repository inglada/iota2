    ...
    for dirname, dirnames, filenames in os.walk(referenceDirectory):
        ...
        for subdirname in dirnames:
            os.mkdir(
                ...
                .replace(referenceDirectory, workingDirectory)
...
class iota_test_Basic(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.iota2_tests_directory = os.path.join(
            self.iota2_directory, "data", "test_features_labels"
        )
    ...
    def test_Basic(self):
        ...
        self.config.setParam(
            "argTrain", "samplesOptions", "-sampler random -strategy all"
        )
    ...
    def test_Basic_CropMix_classif(self):
        ...
        test_vector = os.path.join(
            self.test_working_directory_tmp, "D0005H0002_polygons_1_Sample.shp"
        )
        fut.cpShapeFile(
            vector_file.replace(".shp", ""),

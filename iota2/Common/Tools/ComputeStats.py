...
def computeStats(pathConf, wD=None):
    ...
    for seed in range(runs):
        ...
        # plot relation
        _ = plotRelation(finalDataBasePath, dataField, seed, iota2Folder)
        # Compute statistics
...
if __name__ == "__main__":
    ...
    """
    Example :
    python computeStats.py -wd /work/OT/theia/oso/TMP/sampleExtraction -conf \
    /home/uz/vincenta/config/configS1S2_4Tiles_multiSARdespeckle.cfg
    """

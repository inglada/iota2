...
class iota_testSamplesSelection(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.in_xml_merge = os.path.join(
            IOTA2DIR,
            "data",
            "references",
            "selectionSamples",
        ...
        self.features_ref = os.path.join(
            IOTA2DIR,
            "data",
            "references",
            "selectionSamples",
    ...
    def test_write_xml(self):
        ...
        # assert
        self.assertTrue(
            cmp_xml_stat_files(self.in_xml, xml_test),
    ...
    def test_merge_xml(self):
        ...
        # assert
        self.assertTrue(
            cmp_xml_stat_files(self.in_xml_merge, test_merge),
            msg="merge xml statistics files failed",
        )
    ...
    def test_split_selection(self):
        ...
        self.assertTrue(
            nb_features_t31tdj == nb_feat, msg="split samples selection failed"
        )
        self.assertTrue(
    ...
    def test_samples_selection(self):
        ...
        in_shape_dir = os.path.join(
            self.test_working_directory, "samplesSelTest", "samplesSelection"
        )

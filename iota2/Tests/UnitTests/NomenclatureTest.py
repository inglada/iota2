...
class iota_NomenclatureTest(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.refnomenc = os.path.join(IOTA2DIR, "data", "references/posttreat/nomenclature.txt")
        self.refqml = os.path.join(IOTA2DIR, "data", "references/posttreat/style.qml")
        self.refqmlout = os.path.join(IOTA2DIR, "data", "references/posttreat/styleraster.qml")        

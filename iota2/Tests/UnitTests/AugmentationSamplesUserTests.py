...
class iota_testSamplesAugmentationUser(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.csv_path = os.path.join(
            IOTA2DIR, "data", "references", "dataAugmentation.csv"
        )
    ...
    def setUp(self):
        ...
        self.vector_2 = os.path.join(
            self.test_working_directory, "vector_TEST_2_seed0.sqlite"
        )
    ...
    def test_iota2_dataAugmentationByCopy(self):
        ...
        DataAugmentation.DataAugmentationByCopy(
            "CODE", self.csv_path, [self.vector_1, self.vector_2]
        )
        count = [

...
class DimensionalityReductionTests(unittest.TestCase):
    def setUp(self):
        ...
        self.flDate = [
            "landsat8_b1_20140118",
            "landsat8_b2_20140118",
            "landsat8_b3_20140118",
            "landsat8_b4_20140118",
            "landsat8_b5_20140118",
            "landsat8_b6_20140118",
            "landsat8_b7_20140118",
            "landsat8_ndvi_20140118",
            "landsat8_ndwi_20140118",
            "landsat8_brightness_20140118",
        ]
        ...
        self.testOutputModelFileName = os.path.join(iota2_dataTest, "tmp", "model.pca")
        self.reducedOutputFileName = os.path.join(iota2_dataTest, "reduced.sqlite")
        self.testReducedOutputFileName = os.path.join(
    ...
    def test_GetAvailableFeatures(self):
        ...
        expected = "b1"
        (feats, metaDataFields) = DR.GetAvailableFeatures(
            self.inputSampleFileName, "date", "sensor"
        )
        self.assertEqual(feats["20141017"]["landsat8"][0], expected)

        expected = "landsat8"
        (feats, metaDataFields) = DR.GetAvailableFeatures(
            self.inputSampleFileName, "date", "band"
        )
    ...
    def test_GenerateFeatureListGlobal(self):
        expected = [
            [
                ...
                "landsat8_b6_20140118",
                "landsat8_b7_20140118",
                "landsat8_b1_20140203",
                "landsat8_b2_20140203",
                "landsat8_b3_20140203",
                "landsat8_b4_20140203",
                "landsat8_b5_20140203",
                "landsat8_b6_20140203",
                "landsat8_b7_20140203",
                "landsat8_b1_20140219",
                "landsat8_b2_20140219",
                "landsat8_b3_20140219",
                "landsat8_b4_20140219",
                "landsat8_b5_20140219",
                "landsat8_b6_20140219",
                "landsat8_b7_20140219",
                "landsat8_b1_20140307",
                "landsat8_b2_20140307",
                "landsat8_b3_20140307",
                "landsat8_b4_20140307",
                "landsat8_b5_20140307",
                "landsat8_b6_20140307",
                "landsat8_b7_20140307",
                "landsat8_b1_20140323",
                "landsat8_b2_20140323",
                "landsat8_b3_20140323",
                "landsat8_b4_20140323",
                "landsat8_b5_20140323",
                "landsat8_b6_20140323",
                "landsat8_b7_20140323",
            ]
        ]

        (fl, metaDataFields) = DR.BuildFeaturesLists(self.inputSampleFileName, "global")
        self.assertEqual(expected[0], fl[0][: len(expected[0])])

    def test_GenerateFeatureListDate(self):
        (fl, metaDataFields) = DR.BuildFeaturesLists(self.inputSampleFileName, "date")
    ...
    def test_GenerateFeatureListBand(self):
        ...
        expected = [
            ...
            "landsat8_b2_20140307",
            "landsat8_b2_20140323",
            "landsat8_b2_20140408",
            "landsat8_b2_20140424",
            "landsat8_b2_20140510",
            "landsat8_b2_20140526",
            "landsat8_b2_20140611",
            "landsat8_b2_20140627",
            "landsat8_b2_20140713",
            "landsat8_b2_20140729",
            "landsat8_b2_20140814",
            "landsat8_b2_20140830",
            "landsat8_b2_20140915",
            "landsat8_b2_20141001",
            "landsat8_b2_20141017",
            "landsat8_b2_20141102",
            "landsat8_b2_20141118",
            "landsat8_b2_20141204",
            "landsat8_b2_20141220",
            "landsat8_b2_20141229",
        ]
        (fl, metaDataFields) = DR.BuildFeaturesLists(self.inputSampleFileName, "band")
        self.assertEqual(expected, fl[1])

    def test_ComputeFeatureStatistics(self):
        DR.ComputeFeatureStatistics(
            self.inputSampleFileName, self.testStatsFile, self.flDate
        )
        self.assertTrue(
            filecmp.cmp(self.testStatsFile, self.statsFile, shallow=False),
            msg="Stats files don't match",
        )

    def test_TrainDimensionalityReduction(self):
        DR.TrainDimensionalityReduction(
            self.inputSampleFileName,
        ...
        self.assertTrue(
            filecmp.cmp(
                self.testOutputModelFileName, self.outputModelFileName, shallow=False
            ),
    ...
    def test_ApplyDimensionalityReduction(self):
        ...
        inputDimensions = len(
            fu.getAllFieldsInShape(self.inputSampleFileName, "SQLite")[
                numberOfMetaDataFields:
            ]
        )
        DR.ApplyDimensionalityReduction(
            self.inputSampleFileName,
    ...
    def test_JoinReducedSampleFiles(self):
        ...
        self.assertTrue(
            compareSQLite(
                self.testJointReducedFile, self.jointReducedFile, CmpMode="coordinates"
            ),
            msg="Joined files don't match",
        )
    ...
    def test_SampleFilePCAReduction(self):
        ...
        test_testOutputSampleFileName = (
            iota2_dataTest + "/" + self.testOutputSampleFileName
        )
        DR.SampleFilePCAReduction(
            self.inputSampleFileName,
            test_testOutputSampleFileName,
            "date",
            self.targetDimension,
        ...
        self.assertTrue(
            compareSQLite(
                test_testOutputSampleFileName,
                os.path.join(iota2_dataTest, self.outputSampleFileName),
                CmpMode="coordinates",
            ),
    ...
    def test_ApplyDimensionalityReductionToFeatureStack(self):
        ...
        modelList = [self.outputModelFileName] * len(
            DR.BuildChannelGroups(self.configFile)
        )
        (app, other) = DR.ApplyDimensionalityReductionToFeatureStack(
            self.configFile, imageStack, modelList
        )
    ...
    def test_ApplyDimensionalityReductionToFeatureStackPipeline(self):
        ...
        (appdr, other) = DR.ApplyDimensionalityReductionToFeatureStack(
            self.configFile, app, modelList
        )
        appdr.SetParameterString(
            "out", os.path.join(iota2_dataTest, "tmp", "reducedStackPipeline.tif")
        )
